<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Eyebrow.aspx.cs" Inherits="s13105304003.Eyebrow" %>--%>
...
<body>
    <script>
        (function () {            
            var EyebrowAPI = "http://makeup-api.herokuapp.com/api/v1/products.json?product_type=eyebrow";
            $.getJSON(EyebrowAPI, function (data) {
                for (var i in data) {
                    $("#eyebrow").append(
                        $("<div/>").attr("class", 'col-md-4').attr("style", 'height:400px;').attr("id", 'eyebrowdiv'+ i)
                    );
                    $("#eyebrowdiv" + i).append(
                        $("<div/>").attr("class", 'thumbnail').attr("id", 'eyebrowct' + i)
                    );
                    $("#eyebrowct" + i).append(
    ...
    <!--<form id="form1" runat="server">-->
        <div class="row" style="height:200px; opacity: 0.9; background-image:url(./img/top.jpg); padding:10px;">
            ...
            <div class="col-md-6">                
                <h1 style="padding:20px; font-size:56pt; text-shadow:3px 3px 3px #ffffff; text-align:center; color:#808080;">Eyebrow</h1>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-1"></div>           
        </div>
        <div class="row" style="padding:30px; background-color:lightpink">
            <div class="row" style="margin:10px;" id="eyebrow"></div>            
        </div>
